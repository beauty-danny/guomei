...
// }
//删除绑定事件兼容性函数
// function removEvent(obj,event,fun){
// 	if(obj.removeEventListener){
// 		return obj.removeEventListener(event,fun,false);
// 	}else{
// 		return obj.deleteEvent('on'+event,fun);
// 	}
// }
//条鼠标滚轮的兼容性
...
// 			var ul=$('.a_ul',this)[0];
// 			console.log(ul)
// 			var len=$('.a_li',ul).length;
// 			var bigheight=len*height;
// 			animate(ul,{height:bigheight},500);
// 		},function(){
// 			var that=this;
// 			var ul=$('.a_ul',this)[0];
...
function delCookie(attr){
	...
	document.cookie=attr+'=aas;expires'+now.toGMTString();
}
